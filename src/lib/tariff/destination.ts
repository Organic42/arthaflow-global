...
export const WITS_REPORTERS: Record<string, { code: number; name: string }> = {
  ...
  // reporters that actually returned a rate are listed. Bahrain, Bhutan,
  // Djibouti, Algeria, Iraq and Yemen were probed and REJECTED — the endpoint
  // answers 400 or 404 for them, and listing them would have filled the
  // destination picker with markets that can never be priced.
  ARE: { code: 784, name: "United Arab Emirates" },
  ARG: { code: 32, name: "Argentina" },
  BEN: { code: 204, name: "Benin" },
  BGR: { code: 100, name: "Bulgaria" },
  CAN: { code: 124, name: "Canada" },
  CHL: { code: 152, name: "Chile" },
  CHN: { code: 156, name: "China" },
  CIV: { code: 384, name: "Cote d'Ivoire" },
  CMR: { code: 120, name: "Cameroon" },
  COD: { code: 180, name: "DR Congo" },
  COL: { code: 170, name: "Colombia" },
  CZE: { code: 203, name: "Czechia" },
  DEU: { code: 276, name: "Germany" },
  DMA: { code: 212, name: "Dominica" },
  ...
  GHA: { code: 288, name: "Ghana" },
  GIN: { code: 324, name: "Guinea" },
  GMB: { code: 270, name: "Gambia" },
  GRC: { code: 300, name: "Greece" },
  GUY: { code: 328, name: "Guyana" },
  HKG: { code: 344, name: "Hong Kong SAR" },
  HUN: { code: 348, name: "Hungary" },
  IDN: { code: 360, name: "Indonesia" },
  IND: { code: 356, name: "India" },
  IRL: { code: 372, name: "Ireland" },
  ISR: { code: 376, name: "Israel" },
  ...
  LBR: { code: 430, name: "Liberia" },
  LBY: { code: 434, name: "Libya" },
  LKA: { code: 144, name: "Sri Lanka" },
  MAR: { code: 504, name: "Morocco" },
  MDG: { code: 450, name: "Madagascar" },
  MDV: { code: 462, name: "Maldives" },
  MEX: { code: 484, name: "Mexico" },
  MLI: { code: 466, name: "Mali" },
  MNE: { code: 499, name: "Montenegro" },
  MOZ: { code: 508, name: "Mozambique" },
  MYS: { code: 458, name: "Malaysia" },
  NGA: { code: 566, name: "Nigeria" },
  NLD: { code: 528, name: "Netherlands" },
  NOR: { code: 578, name: "Norway" },
  NPL: { code: 524, name: "Nepal" },
  NZL: { code: 554, name: "New Zealand" },
  OMN: { code: 512, name: "Oman" },
  PER: { code: 604, name: "Peru" },
  PHL: { code: 608, name: "Philippines" },
  POL: { code: 616, name: "Poland" },
  PRT: { code: 620, name: "Portugal" },
  QAT: { code: 634, name: "Qatar" },
  ROU: { code: 642, name: "Romania" },
  RUS: { code: 643, name: "Russian Federation" },
  SAU: { code: 682, name: "Saudi Arabia" },
  SDN: { code: 729, name: "Sudan" },
  SEN: { code: 686, name: "Senegal" },
  SGP: { code: 702, name: "Singapore" },
  SLE: { code: 694, name: "Sierra Leone" },
  SOM: { code: 706, name: "Somalia" },
  SWE: { code: 752, name: "Sweden" },
  SYC: { code: 690, name: "Seychelles" },
  TGO: { code: 768, name: "Togo" },
  THA: { code: 764, name: "Thailand" },
  TUR: { code: 792, name: "Türkiye" },
  TWN: { code: 158, name: "Taiwan" },
  TZA: { code: 834, name: "Tanzania" },
  UGA: { code: 800, name: "Uganda" },
  USA: { code: 840, name: "United States" },
  VEN: { code: 862, name: "Venezuela" },
  VNM: { code: 704, name: "Viet Nam" },
  ZAF: { code: 710, name: "South Africa" },
  ZMB: { code: 894, name: "Zambia" },
};
